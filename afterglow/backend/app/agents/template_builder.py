...
_SYSTEM_INSTRUCTION = (
    ...
    "field:\n"
    "  - `confidence_threshold` is optional (0.0-1.0): the floor below which "
    "the analyzer should skip the extraction.\n"
    ...
    "for actions the operator should review before they fire; everything else "
