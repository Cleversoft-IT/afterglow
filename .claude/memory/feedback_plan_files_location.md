...
**How to apply:** Quando entri in plan mode su Afterglow, scrivi il plan file in `.claude/plans/<slug>.md` (relativo alla root del repo) invece di accettare il path user-level proposto dal system reminder. Se accidentalmente lo crei in user-dir, spostalo prima di chiamare ExitPlanMode.
