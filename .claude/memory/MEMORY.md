...
- [Wizard agentico draft-first](feedback_wizard_agentic.md) — Wizard è agentico (draft-first + budget 2-5 domande hard ceiling 5), NON form a slot né script con singola domanda; logica nel prompt+meta-state, no post-processing hard-coded
