...
In Afterglow "**produzione**" = la demo URL pubblica dell'hackathon (https://afterglow.cleversoft.it, che embeds https://app.afterglow.cleversoft.it) durante e per la judging window dell'AI Agent Olympics @ Milan AI Week 2026 (deadline 19 maggio 2026 17:00 CEST). **Tutto ciò che è "post-hackathon" è out of scope.**
